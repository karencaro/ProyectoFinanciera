...
<asp:Content ID="Content2" ContentPlaceHolderID="chpContenido" runat="server">
        ...
        <p class="auto-style14">
            ...
            <span class="auto-style15">Asesor financiero</span></span></p>
        <p>
        </p>
        <p class="auto-style16">
            <span class="nuevoEstilo2">Usuario:</span></p>
        <p>
            <asp:TextBox ID="txtEmail" runat="server" CssClass="auto-style17"></asp:TextBox>
        </p>
        <p class="auto-style16">
            <span class="nuevoEstilo2">Contraseña:</span></p>
        <p>
            <asp:TextBox ID="txtPassword" runat="server" CssClass="auto-style18"></asp:TextBox>
        </p>
        <p>
        </p>
        <p>
            <asp:Button ID="Button1" runat="server" CssClass="auto-style19" Text="Aceptar" OnClick="Button1_Click1" />
        </p>
        <p>
        </p>
    </form>
